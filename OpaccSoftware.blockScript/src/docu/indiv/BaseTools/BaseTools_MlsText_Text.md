...
// Getting MLS Text (TEXT only) with given key - creates key if not found!
var mlsText := BaseTools_MlsText_Text(mlsKey,uiLangNo,newText,newShortText,newInfoText,replaceText, ...)
```
----
#### Arguments:
```ts
